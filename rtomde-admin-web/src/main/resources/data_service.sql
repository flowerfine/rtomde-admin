...
CREATE TABLE `sys_dept` (
  ...
  `code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '部门标识',
  ...
  `comments` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '备注',
  PRIMARY KEY (`id`),
...
CREATE TABLE `sys_organization` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `name` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '组织名称',
  `avatar` varchar(256) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '头像',
  `desc` varchar(256) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '描述',
  `deleted` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '删除标识。0: 未删除, 1: 已删除',
  `creator` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'system' COMMENT '创建人 ',
...
CREATE TABLE `sys_role` (
  ...
  `code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '角色标识',
  `organization_id` bigint NOT NULL COMMENT '组织id',
  `avatar` varchar(256) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '头像',
  `desc` varchar(256) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '描述',
